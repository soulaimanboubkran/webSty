...
const Toast = () => {
  ...
  return (
    <>
      <h1 className="text-3xl font-bold pb-5">Toast</h1>
      {toast.map((item) => (
        <div key={item.id} >
...
<div className="flex justify-between items-center py-10 px-5">
        <Link to='/Skeleton' className="border px-20 py-2 rounded-xl font-semibold hover:scale-105  bg-white text-black">
          Previous
        </Link>
        <Link to='/Tooltip' className="border px-20 py-2 rounded-xl font-semibold hover:scale-105 bg-black text-white">
          Next
        </Link>
      </div>
    </>
