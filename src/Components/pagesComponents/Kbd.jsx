...
const Kbd = () => {
  ...
  return (
    <>
      <h1 className="text-3xl font-bold pb-5">Kbd</h1>
      {kbd.map((item) => (
        <div key={item.id} >
...
<div className="flex justify-between items-center py-10 px-5">
        <Link to='/Collapse' className="border px-20 py-2 rounded-xl font-semibold hover:scale-105  bg-white text-black">
          Previous
        </Link>
        <Link to='/Stat' className="border px-20 py-2 rounded-xl font-semibold hover:scale-105 bg-black text-white">
          Next
        </Link>
      </div>
    </>
